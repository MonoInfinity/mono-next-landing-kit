            ...
            item.children ? (
                <div className={`relative w-fit sm:w-full z-index-10`} key={`${item.name}-${level}-${index}`}>
                    <div className={`cursor-pointer group`}>
                        <button className="w-auto px-6 py-2 duration-300 rounded-lg dark:text-white text-violet-500 hover:text-violet-700 hover:bg-slate-100 text-start">
                            {item.name}
                        </button>
                        <div
                ...
                <Link href={item.path} passHref key={`${item.name}-${level}-${index}`}>
                    <button
                        ...
                        className={` py-2 w-36 dark:text-white dark:hover:text-violet-500 text-violet-500 hover:text-violet-700 text-left duration-300  rounded-lg`}
                    >
                        {item.name}
                    </button>
                </Link>
