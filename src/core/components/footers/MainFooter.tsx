            ...
            <div className="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-2 gap-8 mt-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
                        ...
                        <div className="col-span-2 lg:col-span-3 lg:flex lg:items-end">
                            <form className="w-full text-white">
                                ...
                                <div className="p-2 border border-white/10 sm:flex sm:items-center">
                                    <input
                                    ...
                                    />
                                    <button
                                        className="w-full h-12 px-6 py-3 mt-1 text-sm font-bold tracking-wide uppercase bg-red-700 sm:ml-4 sm:mt-0 sm:w-auto sm:flex-shrink-0"
                                        type="submit"
                                    >
                                        Sign Up
                                    </button>
                        ...
                        <div className="col-span-2 pt-6 border-t border-white/10 sm:col-span-1">
                            <p className="font-bold text-white">Services</p>
                            <nav className="flex flex-col mt-6 space-y-4 text-sm text-gray-300">
                                <a className="inline-block"> 1on1 Coaching </a>
                                <a className="inline-block"> Company Review </a>
                                <a className="inline-block"> Accounts Review </a>
                                <a className="inline-block"> HR Consulting </a>
                                <a className="inline-block"> SEO Optimisation </a>
                            </nav>
                        </div>
                        <div className="col-span-2 pt-6 border-t border-white/10 sm:col-span-1">
                            ...
                            <nav className="flex flex-col mt-6 space-y-4 text-sm text-gray-300">
                                ...
                                <a className="inline-block"> Meet the Team </a>
                                <a className="inline-block"> History </a>
                                <a className="inline-block"> Careers </a>
                            </nav>
                        </div>
                        <div className="col-span-2 pt-6 border-t border-white/10 sm:col-span-1">
                            ...
                            <nav className="flex flex-col mt-6 space-y-4 text-sm text-gray-300">
                                ...
                                <a className="inline-block"> FAQs </a>
                                <a className="inline-block"> Live Chat </a>
                            </nav>
                        </div>
                        <div className="col-span-2 pt-6 border-t border-white/10 sm:col-span-1">
                            <p className="font-bold text-white">Legal</p>
                            <nav className="flex flex-col mt-6 space-y-4 text-sm text-gray-300">
                                <a className="inline-block"> Accessibility </a>
                                <a className="inline-block"> Returns Policy </a>
                                <a className="inline-block"> Refund Policy </a>
                                <a className="inline-block"> Hiring Statistics </a>
                            </nav>
                        </div>
                        <div className="col-span-2 pt-6 border-t border-white/10 sm:col-span-1">
                            <p className="font-bold text-white">Downloads</p>
                            <nav className="flex flex-col mt-6 space-y-4 text-sm text-gray-300">
                                <a className="inline-block"> Marketing Calendar </a>
                                <a className="inline-block"> SEO Infographics </a>
                            </nav>
                        </div>
                ...
                <div className="pt-8 mt-12 border-t border-white/10">
                    <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
                        <p className="text-xs text-center text-gray-400 lg:text-left">Copyright © 2022. Tripper. All rights reserved.</p>
