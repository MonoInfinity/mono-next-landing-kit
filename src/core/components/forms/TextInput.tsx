    ...
    return (
        <div className="space-y-2">
            ...
            <input
                ...
                type={type}
                className={_clsx(
                    'py-1.5 px-2 block w-full duration-300 border-2 border-gray-300 rounded-sm shadow-sm outline-none focus:ring-primary-500 focus:border-primary-500 sm:text-sm text-gray-200',
                    {
