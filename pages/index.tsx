                                    ...
                                    <div className="flex flex-col items-center space-y-8 lg:space-y-0">
                                        <ul className="space-y-4">
                                            <li className="space-y-1">
                                                ...
                                                <p
                                                    className={clsx(
                                                        ' dark:text-gray-300 text-gray-800 duration-300 t lg:text-lg md:text-base text-sm '
                                                    )}
                                                >
                                                    Design for all devices, from desktop to mobile, and everything in between. We make sure your app
                                            ...
                                            <li className="space-y-1">
                                                ...
                                                >
                                                    Make your app beautiful and unique with our customizable design. You can change colors, fonts, and
                                                    so on.
                                                </p>
                                            </li>
                                            <li className="space-y-1">
                                                ...
                                                >
                                                    Improve your search engine ranking, drive more traffic to your website, and increase your revenue
                                                    with
                                                </p>
                                            </li>
                                        </ul>
                                ...
                                <div className="flex flex-col space-y-8">
                                    <div className="flex flex-col items-center px-4 space-y-4 lg:items-end lg:space-y-14">
                                        ...
                                        <p className="max-w-md text-base lg:text-xl dark:text-gray-300 text-violet-600">
                                            Begin the process by providing us with a high level overview of the project you are interested in and we
                                            will be in touch!
                                        </p>
                                    </div>
                                </div>
